...
#include "navigation_robot_custom_interfaces/srv/detail/find_closest_wall__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = navigation_robot_custom_interfaces::srv::FindClosestWall_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const navigation_robot_custom_interfaces::srv::FindClosestWall_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<navigation_robot_custom_interfaces::srv::FindClosestWall_Request *>(
    untyped_ros_message);
...
{
  return &navigation_robot_custom_interfaces::srv::typesupport_fastrtps_cpp::_FindClosestWall_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = navigation_robot_custom_interfaces::srv::FindClosestWall_Response;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const navigation_robot_custom_interfaces::srv::FindClosestWall_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<navigation_robot_custom_interfaces::srv::FindClosestWall_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &navigation_robot_custom_interfaces::srv::typesupport_fastrtps_cpp::_FindClosestWall_Response__handle;
}
...
{
  return &navigation_robot_custom_interfaces::srv::typesupport_fastrtps_cpp::_FindClosestWall__handle;
}
