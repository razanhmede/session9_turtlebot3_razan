...
class Metaclass_FindClosestWall(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'navigation_robot_custom_interfaces.srv.FindClosestWall')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from navigation_robot_custom_interfaces.srv import _find_closest_wall
...
class FindClosestWall(metaclass=Metaclass_FindClosestWall):
    from navigation_robot_custom_interfaces.srv._find_closest_wall import FindClosestWall_Request as Request
    from navigation_robot_custom_interfaces.srv._find_closest_wall import FindClosestWall_Response as Response
